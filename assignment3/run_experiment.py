...
if __name__ == '__main__':
    ...
    dataset1_details = {
            ...
            'best_nn_params': {'NN__activation': ['relu'], 'NN__alpha': [0.3162277660168379],
                               'NN__hidden_layer_sizes': [(42)], 'NN__learning_rate_init': [0.064]}
        }
    dataset2_details = {
            'data': loader.SpamData(verbose=verbose, seed=seed),
            'name': 'spam_data',
            'readable_name': 'Spam Data',
                        'best_nn_params': {'NN__activation': ['relu'], 'NN__alpha': [0.03162277660168379],
                               'NN__hidden_layer_sizes': [(28, 28, 28)], 'NN__learning_rate_init': [0.008]}
        }
    # dataset1_details = {
